...
class TestNotifications:
    ...
    @pytest.mark.asyncio
    async def test_add_new_notification(self, mock_db_session, frozen_time):
    ...
    @pytest.mark.asyncio
    async def test_mark_as_completed_sets_processed_at(self, mock_db_session, frozen_time):
    ...
    @pytest.mark.asyncio
    async def test_mark_as_completed_when_already_completed(self, mock_db_session, frozen_time):
