...
class TestConstructUserSettingsResponse:
    ...
    @patch("areyouok_telegram.handlers.settings_utils.async_database")
    @patch("areyouok_telegram.handlers.settings_utils.UserMetadata.get_by_user_id")
    async def test_construct_user_settings_response_partial_metadata(self, mock_get_by_user_id, mock_async_database):
    ...
    @patch("areyouok_telegram.handlers.settings_utils.async_database")
    @patch("areyouok_telegram.handlers.settings_utils.UserMetadata.get_by_user_id")
    async def test_construct_user_settings_response_database_error(self, mock_get_by_user_id, mock_async_database):
    ...
    @patch("areyouok_telegram.handlers.settings_utils.async_database")
    @patch("areyouok_telegram.handlers.settings_utils.UserMetadata.get_by_user_id")
    async def test_construct_user_settings_response_empty_string_values(self, mock_get_by_user_id, mock_async_database):
